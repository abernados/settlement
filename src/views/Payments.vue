                ...
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      >
                        {{
                          moment(payment.paid_at).format("MMMM D, YYYY h:mm a")
                        }}
                      </td>
                      <td class="pr-6">
                        <Menu
...
export default {
  ...
  methods: {
    async getPayments() {
      axios.get(`http://3.136.157.5:6060/api/v1/payments`).then((response) => {
